  ...
  <div class="shader-visualizer">
    ...
    <div class="explanation-panel">
      <div class="step-navigation">
        ...
        <button @click="nextStep" :disabled="currentStep === steps.length - 1" class="nav-button">
          Next
        </button>
      </div>
...
.code-line :deep(.function) {
  color: #dcdcaa
}

.code-line :deep(.variable) {
  color: #9cdcfe
}

.code-line :deep(.number) {
  color: #b5cea8
}
</style>